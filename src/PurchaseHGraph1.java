/**
 * class to construct a hypergraph for the stockId 32673 using lcs threshold >= 10
 */
...
public class PurchaseHGraph1 {
	...
	public static void main(String[] args) throws SQLException, FileNotFoundException {
		...
		String query = "select InsiderId,Date from insidertrades2_demo where Action = 'Buy'  AND  StockId = 32673 " ;
		...
		lcs3ids=insiderdatesets(lcs2ids,inid_date_map);
		lcs4ids=insiderdatesets(lcs3ids,inid_date_map);
		lcs5ids=insiderdatesets(lcs4ids,inid_date_map);
		lcs6ids=insiderdatesets(lcs5ids,inid_date_map);
		lcs7ids=insiderdatesets(lcs6ids,inid_date_map);
		lcs8ids=insiderdatesets(lcs7ids,inid_date_map);
		lcs9ids=insiderdatesets(lcs8ids,inid_date_map);
		lcs10ids=insiderdatesets(lcs9ids,inid_date_map);
		lcs11ids=insiderdatesets(lcs10ids,inid_date_map);
		lcs12ids=insiderdatesets(lcs11ids,inid_date_map);
		lcs13ids=insiderdatesets(lcs12ids,inid_date_map);
		lcs14ids=insiderdatesets(lcs13ids,inid_date_map);
		lcs15ids=insiderdatesets(lcs14ids,inid_date_map);
		...
		HashMap<HashSet<Integer>,TreeSet<Date>> finalmap = new HashMap<HashSet<Integer>,TreeSet<Date>>(lcs15ids);
		finalmap.putAll(highorder(lcs15ids,lcs13ids));
		finalmap.putAll(highorder(lcs13ids,lcs12ids));
		finalmap.putAll(highorder(lcs12ids,lcs11ids));
		finalmap.putAll(highorder(lcs11ids,lcs10ids));
		finalmap.putAll(highorder(lcs10ids,lcs9ids));
