/**
 * class to construct a hypergraph for the stockId 3955 using lcs threshold >= 5
 */
...
public class SaleHGraph6 {
	...
	public static void main(String[] args) throws SQLException, FileNotFoundException {
		...
		String query = "select InsiderId,Date from insidertrades2_demo where Action = 'Sell'  AND  StockId = 3955 " ;
