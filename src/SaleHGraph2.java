/**
 * class to construct a hypergraph for the stockId 13 using lcs threshold >= 5
 */
...
public class SaleHGraph2 {
	...
	public static void main(String[] args) throws SQLException, FileNotFoundException {
		...
		String query = "select InsiderId,Date from insidertrades2_demo where Action = 'Sell'  AND  StockId = 13 " ;
