/**
 * class to construct a hypergraph for the stockId 32063 using lcs threshold >= 5
 */
...
public class SaleHGraph1 {
	...
	public static void main(String[] args) throws SQLException, FileNotFoundException {
		...
		String query = "select InsiderId,Date from insidertrades2_demo where Action = 'Sell'  AND  StockId = 32063 " ;
		...
		HashMap<HashSet<Integer>,TreeSet<Date>> finalmap = new HashMap<HashSet<Integer>,TreeSet<Date>>(lcs12ids);
		finalmap.putAll(highorder(lcs12ids,lcs11ids));
		finalmap.putAll(highorder(lcs11ids,lcs9ids));
		finalmap.putAll(highorder(lcs9ids,lcs7ids));
		finalmap.putAll(highorder(lcs7ids,lcs6ids));
		finalmap.putAll(highorder(lcs6ids,lcs4ids));
		finalmap.putAll(highorder(lcs4ids,lcs3ids));
		finalmap.putAll(highorder(lcs3ids,lcs2ids));
