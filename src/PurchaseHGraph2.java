/**
 * class to construct a hypergraph for the stockId 1837 using lcs threshold >= 10
 */
...
public class PurchaseHGraph2 {
	...
	public static void main(String[] args) throws SQLException, FileNotFoundException {
		...
		String query = "select InsiderId,Date from insidertrades2_demo where Action = 'Buy'  AND  StockId = 1837 " ;
		...
		HashMap<HashSet<Integer>,TreeSet<Date>> finalmap = new HashMap<HashSet<Integer>,TreeSet<Date>>(lcs10ids);
		finalmap.putAll(highorder(lcs10ids,lcs9ids));
		finalmap.putAll(highorder(lcs9ids,lcs8ids));
		finalmap.putAll(highorder(lcs8ids,lcs7ids));
		finalmap.putAll(highorder(lcs7ids,lcs6ids));
		finalmap.putAll(highorder(lcs6ids,lcs5ids));
		finalmap.putAll(highorder(lcs5ids,lcs4ids));
