/**
 * class to construct a hypergraph for the stockId 31960 using lcs threshold >= 5
 */
...
public class SaleHGraph4 {
	...
	public static void main(String[] args) throws SQLException, FileNotFoundException {
		...
		String query = "select InsiderId,Date from insidertrades2_demo where Action = 'Sell'  AND  StockId = 31960 " ;
		...
		HashMap<HashSet<Integer>,TreeSet<Date>> finalmap = new HashMap<HashSet<Integer>,TreeSet<Date>>(lcs8ids);
