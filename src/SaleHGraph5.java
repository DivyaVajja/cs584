/**
 * class to construct a hypergraph for the stockId 10716 using lcs threshold >= 5
 */
...
public class SaleHGraph5 {
	...
	public static void main(String[] args) throws SQLException, FileNotFoundException {
		...
		String query = "select InsiderId,Date from insidertrades2_demo where Action = 'Sell'  AND  StockId = 10716 " ;
		...
		//System.out.println(lcs3ids.keySet().size());
